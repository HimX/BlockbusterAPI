...
class OldieRentalValue extends AbstractRentalValue
{
    ...
    public function __construct(Rental $rental)
    {
        ...
        $this->minDaysWithNormalFee = config('app.oldie_movie_min_days_with_normal_fee', 3);
        $this->increaseRate = config('app.oldie_movie_increase_rate', 1);
    }
